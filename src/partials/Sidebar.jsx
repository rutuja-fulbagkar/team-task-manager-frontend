      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <img src={logo} alt="Logo" className="w-auto max-w-auto" />
          </NavLink>
        </div>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${/^\/(project)(\/|$)/.test(
                          pathname
                        )
                            ? ""
                            : "hover:text-gray-900 dark:hover:text-white"
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <Inventory2RoundedIcon
                              className={`shrink-0 fill-current ${/^\/(project)(\/|$)/.test(
                                pathname
                              )
                                  ? "text-violet-500"
                                  : "text-gray-400 dark:text-gray-500"
