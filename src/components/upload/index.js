...
export { default as UploadCompanyLogo } from './UploadCompanyLogo';
export { default as UploadBackgroundImage } from './UploadBackgroundImage';
export { default as UploadRecruitCompanyLogo } from './UploadRecruitCompanyLogo';
